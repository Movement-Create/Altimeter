...
function registerCommands(context, runner, chatProvider, statusBar, outputChannel) {
    // Open Chat
    context.subscriptions.push(vscode.commands.registerCommand('altimeter.openChat', async () => {
        await vscode.commands.executeCommand('altimeter.chatView.focus');
    }));
    // Run Prompt (quick input → shows result in output + notification)
    context.subscriptions.push(vscode.commands.registerCommand('altimeter.runPrompt', async () => {
    ...
    // Run on Selection
    context.subscriptions.push(vscode.commands.registerCommand('altimeter.runOnSelection', async () => {
    ...
    // Explain Selection
    context.subscriptions.push(vscode.commands.registerCommand('altimeter.explainSelection', async () => {
        const editor = vscode.window.activeTextEditor;
        if (!editor) {
            vscode.window.showWarningMessage('No active editor');
            return;
    ...
    // Fix Selection
    context.subscriptions.push(vscode.commands.registerCommand('altimeter.fixSelection', async () => {
        const editor = vscode.window.activeTextEditor;
        if (!editor) {
            vscode.window.showWarningMessage('No active editor');
            return;
    ...
    context.subscriptions.push(vscode.commands.registerCommand('altimeter.explainInChat', async () => {
        await vscode.commands.executeCommand('altimeter.explainSelection');
    }));
    // Context menu: Fix in Chat
    context.subscriptions.push(vscode.commands.registerCommand('altimeter.fixInChat', async () => {
        await vscode.commands.executeCommand('altimeter.fixSelection');
    }));
    // Context menu: Ask Altimeter
    context.subscriptions.push(vscode.commands.registerCommand('altimeter.askAltimeter', async () => {
        await vscode.commands.executeCommand('altimeter.runOnSelection');
    }));
    // List Tools
    context.subscriptions.push(vscode.commands.registerCommand('altimeter.listTools', async () => {
    ...
    // List Sessions
    context.subscriptions.push(vscode.commands.registerCommand('altimeter.listSessions', async () => {
        await vscode.window.withProgress({
            location: vscode.ProgressLocation.Notification,
    ...
    // Add Memory
    context.subscriptions.push(vscode.commands.registerCommand('altimeter.addMemory', async () => {
    ...
    // Search Memory
    context.subscriptions.push(vscode.commands.registerCommand('altimeter.searchMemory', async () => {
...
function buildCodePrompt(instruction, code, languageId) {
